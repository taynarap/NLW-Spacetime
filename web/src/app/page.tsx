...
export default function Home() {
  return <main className="grid grid-cols-2 min-h-screen">
    {/*Left Column */}
    <div className="relative bg-[url(../assets/bg-stars.svg)] flex flex-col items-start justify-between overflow-hidden px-28 py-16 border-r border-white/10">
      ...
      <a href="" className="flex items-center gap-3 text-left hover:text-gray-50 transition-colors">
        ...
        <p className="text-sm leading-snug max-w-[140px]">
          <span className="underline">Crie sua conta 
